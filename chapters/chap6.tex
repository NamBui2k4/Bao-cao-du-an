...
\begin{figure}[H]
    ...
    \begin{minipage}{0.40\textwidth}
        \centering
        \fcolorbox{lightborder}{white}{\includegraphics[width=0.90\textwidth]{images/screen1.PNG}}
        \caption*{\textbf{Main Screen}}
    \end{minipage}
    \hspace{0.04\textwidth}
    \begin{minipage}{0.40\textwidth}
        \centering
        \fcolorbox{lightborder}{white}{\includegraphics[width=0.90\textwidth]{images/screen2.PNG}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.40\textwidth}
        \centering
        \fcolorbox{lightborder}{white}{\includegraphics[width=0.90\textwidth]{images/screen3.PNG}}
        \caption*{\textbf{Account Overview}}
    \end{minipage}
    \hspace{0.04\textwidth}
    \begin{minipage}{0.40\textwidth}
        \centering
        \fcolorbox{lightborder}{white}{\includegraphics[width=0.90\textwidth]{images/screen4.PNG}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.40\textwidth}
        \centering
        \fcolorbox{lightborder}{white}{\includegraphics[width=0.90\textwidth]{images/screen5.PNG}}
        \caption*{\textbf{Booking Screen}}
    \end{minipage}
    \hspace{0.04\textwidth}
    \begin{minipage}{0.40\textwidth}
        \centering
        \fcolorbox{lightborder}{white}{\includegraphics[width=0.90\textwidth]{images/screen6.PNG}}
